...
`,(class t extends HTMLElement{#p=null;#r=null;#w=null;#s=void 0;#t=null;#k;static customAnimations;#e="api";constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(G.content.cloneNode(!0))}static get observedAttributes(){return["open","duration","close-label"]}attributeChangedCallback(t,e,o){if(!(!this.isConnected||e===o))switch(t){case"open":this.#A();break;case"duration":this.#i(),this.#h()&&this.#o();break;case"close-label":this.#m()}}get closable(){return this.hasAttribute("closable")}set closable(t){this.toggleAttribute("closable",!!t)}get open(){return this.hasAttribute("open")}set open(t){this.toggleAttribute("open",!!t)}get duration(){let t=this.getAttribute("duration");if(null===t)return 1/0;let e=Number(t);return Number.isNaN(e)?1/0:e}set duration(t){this.setAttribute("duration",null!=t?t.toString():t)}get variant(){return this.getAttribute("variant")||""}set variant(t){this.setAttribute("variant",t)}get closeLabel(){return this.getAttribute("close-label")||"Close"}set closeLabel(t){this.setAttribute("close-label",null!=t?t.toString():t)}get customAnimations(){return this.#k}set customAnimations(t){this.#k=t}connectedCallback(){this.#E("closable"),this.#E("open"),this.#E("duration"),this.#E("variant"),this.#E("closeLabel"),this.#E("customAnimations"),this.#p=this.shadowRoot?.querySelector(".alert")??null,this.#r=this.shadowRoot?.querySelector(".alert__close")??null,this.#w=this.shadowRoot?.querySelector('slot[name="close"]')??null,this.#r?.addEventListener("click",this.#d),this.#w?.addEventListener("slotchange",this.#u),this.addEventListener("mouseenter",this.#l),this.addEventListener("mouseleave",this.#n),this.addEventListener("command",this.#v),this.open?(this.#p?.removeAttribute("hidden"),this.#h()&&this.#o()):this.#p?.setAttribute("hidden",""),this.closeLabel&&this.#m()}disconnectedCallback(){this.#i(),this.#r?.removeEventListener("click",this.#d),this.#w?.removeEventListener("slotchange",this.#u),this.removeEventListener("mouseenter",this.#l),this.removeEventListener("mouseleave",this.#n),this.removeEventListener("command",this.#v)}#A(){this.#i(),this.open?(this.#h()&&this.#o(),this.#p?.removeAttribute("hidden"),this.#c("alert-show"),this.#y(this.#p)?.finished.finally(()=>{this.#c(F)})):(this.#c("alert-hide",{reason:this.#e}),this.#b(this.#p)?.finished.finally(()=>{this.#p?.setAttribute("hidden",""),this.#c(V,{reason:this.#e}),this.#e="api"}))}#i(){void 0!==this.#s&&(clearTimeout(this.#s),this.#s=void 0)}#o(){this.#s=window.setTimeout(()=>{this.#e="timeout",this.open=!1},this.duration)}#h(){return this.open&&this.duration!==1/0}#d=()=>{this.closable&&(this.#e="user",this.open=!1)};#l=()=>{this.#i()};#n=()=>{this.#i(),this.#h()&&this.#o()};#u=()=>{this.#m()};#v=t=>{switch(t.command){case"--alert-show":this.open=!0;break;case"--alert-hide":this.#e="api",this.open=!1}};#m(){this.#r&&((this.#w?.assignedElements()||[])?.some(t=>t.textContent?.replace(/\s/g,"")!=="")?this.#r.removeAttribute("aria-label"):this.#r.setAttribute("aria-label",this.closeLabel))}#x(){let e=window.matchMedia("(prefers-reduced-motion: reduce)").matches,o={show:{keyframes:[{opacity:0,transform:"scale(0.9)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}},hide:{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.9)"}],options:{duration:250,easing:"ease"}}},i=this.customAnimations||t.customAnimations||{},r=r=>{let s=i[r]?.options??{},a=o[r].options;return{...a,...s,duration:e||null===this.customAnimations||null===t.customAnimations?0:s.duration??a.duration}};return{show:{keyframes:i.show?.keyframes??o.show.keyframes,options:r("show")},hide:{keyframes:i.hide?.keyframes??o.hide.keyframes,options:r("hide")}}}#y(t){let{keyframes:e,options:o}=this.#x().show;return t?.animate(e,o)}#b(t){let{keyframes:e,options:o}=this.#x().hide;return t?.animate(e,o)}#c(t,e=null){let o=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});this.dispatchEvent(o)}#a(t,e){return new Promise(o=>{t.addEventListener(e,e=>{e.target===t&&o()},{once:!0})})}show(){return this.open?Promise.resolve():(this.open=!0,this.#a(this,F))}hide(){return this.open?(this.open=!1,this.#a(this,V)):Promise.resolve()}toast(t={}){if(t={forceRestart:!1,...t},this.#t){if(!t.forceRestart)return this.#t.promise;this.#t.resolve(),this.#t.cleanup()}let e=()=>{},o=new Promise(t=>e=t),i=()=>{this.#t?.resolve(),this.#t?.cleanup()};this.#t={promise:o,resolve:e,cleanup:()=>{this.removeEventListener(V,i),this.parentNode===U&&U.removeChild(this),U.querySelector(j)||U.remove(),this.open=!1,this.#t=null}},U.parentElement||document.body.append(U),U.appendChild(this),this.#p?.setAttribute("data-toast",""),this.open=!0;let r=U.shadowRoot?.querySelector(".stack");return r?.scrollTo({top:r.scrollHeight}),this.addEventListener(V,i,{once:!0}),o}#E(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(e=j){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}}).defineCustomElement();const Z=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"],Y="https://api.upcdatabase.org";let J="";if("undefined"!=typeof window){let t=window.location.hostname;("localhost"===t||"127.0.0.1"===t)&&(J="http://localhost:8787")}const K=J;function X(t){return new Promise(function(e,o){t.oncomplete=t.onsuccess=function(){return e(t.result)},t.onabort=t.onerror=function(){return o(t.error)}})}function Q(){var t,e,o,r;return i||(t="keyval-store",e="keyval",r=function(){if(o)return o;var i=indexedDB.open(t);return i.onupgradeneeded=function(){return i.result.createObjectStore(e)},(o=X(i)).then(function(t){t.onclose=function(){return o=void 0}},function(){}),o},i=function(t,o){return r().then(function(i){return o(i.transaction(e,t).objectStore(e))})}),i}const tt="barcode-scanner/",te="settings",to="history",ti=async t=>{try{return[null,await function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:Q();return e("readonly",function(e){return X(e.get(t))})}(t)]}catch(t){return[t,void 0]}},tr=async(t,e)=>{try{return await function(t,e){var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:Q();return o("readwrite",function(o){return o.put(e,t),X(o.transaction)})}(t,e),[null]}catch(t){return[t]}},ts=async()=>ti(tt+te),ta=async t=>tr(tt+te,t),tn=async()=>ti(tt+to),tl=async t=>tr(tt+to,t);function td(t,e=0,o=!1){let i=null;if("function"!=typeof t)throw TypeError("Expected a function for first argument");return(...r)=>{clearTimeout(i),o&&!i&&t(...r),i=setTimeout(()=>{i=null,o||t(...r)},e)}}const tc={info:(...t)=>{},error:(...t)=>{},warn:(...t)=>{}};async function th(t,e){if(!t||!e)return;let o=t.querySelector(`bs-result[value="${e}"]`);o&&o.remove();let i=document.createElement("bs-result");i.setAttribute("value",e),i.setAttribute("role","alert"),i.setAttribute("aria-live","assertive"),i.setAttribute("aria-atomic","true"),t.insertBefore(i,t.firstElementChild),t.scrollTop=0}const tu=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return e=>{let{duration:o,frequency:i,volume:r,type:s,onEnded:a}=e,n=t.createOscillator(),l=t.createGain();n.connect(l),l.connect(t.destination),r&&(l.gain.value=r),i&&(n.frequency.value=i),s&&(n.type=s),"function"==typeof a&&(n.onended=a),n.start(t.currentTime),n.stop(t.currentTime+(o||500)/1e3)}})();async function tm(t=0){if("function"==typeof window.navigator.vibrate)try{window.navigator.vibrate(t)}catch{}}let tp=0;async function tb(t={}){let{success:e=!0}=t,[,o]=await ts();if(!o)return;let i=Date.now();i-tp<1e3||(o.beep&&tu(e?{duration:200,frequency:860,volume:.03,type:"square"}:{duration:300,frequency:200,volume:.05,type:"sawtooth"}),o.vibrate&&tm(e?100:200),tp=i)}function tg(t,e){if(!t||!e)return;let o=t.getBoundingClientRect();e.style.cssText=`width: ${o.width}px; height: ${o.height}px`}const tv=["aztec","code_128","code_39","code_93","codabar","data_matrix","ean_13","ean_8","itf","pdf417","qr_code","upc_a","upc_e"];class tf{static async polyfill(){if("BarcodeDetector"in window)tc.info("Using the native BarcodeDetector API.");else try{await n("3jPiW"),tc.info("Using BarcodeDetector polyfill.")}catch(t){throw Error("BarcodeDetector API is not supported by your browser.",{cause:t})}}static async getSupportedFormats(){let t=await window.BarcodeDetector.getSupportedFormats()||[];return tv.filter(e=>t.includes(e))}static async create(t){let e=Array.isArray(t)&&t.length>0?t:await tf.getSupportedFormats();return new tf(e)}static async setup(){try{return await tf.polyfill(),{barcodeReaderError:null}}catch(t){return{barcodeReaderError:t}}}constructor(t){this.barcodeReader=new window.BarcodeDetector({formats:t})}async detect(t){if(!this.barcodeReader)throw Error("BarcodeReader is not initialized.");let e=await this.barcodeReader.detect(t);if(Array.isArray(e)&&e.length>0){let t=e[0];return tc.info({rawValue:t.rawValue,format:t.format}),t}throw Error("Could not detect barcode from provided source.")}}const ty=t=>t.replace(/\/+$/,"");async function tw(t){if(!t||!/^[0-9]{12,14}$/.test(t))return null;if(!Y)return tc.info("Item info API URL not configured; skipping lookup."),null;let e="undefined"!=typeof window&&window?.location,o=K||"";if(!o&&e){let t=window.location.hostname;("localhost"===t||"127.0.0.1"===t)&&(o="http://localhost:8787")}let i=ty(o&&o.length>0?o:Y),r={};async function s(t,e={}){try{let o=await fetch(t,{headers:r,...e});if(!o.ok)return{status:o.status,json:null};try{let t=await o.json();return{status:o.status,json:t}}catch(t){return tc.warn("Non-JSON response from item API",t),{status:o.status,json:null}}}catch(t){return tc.warn("Request failed",t),{status:0,json:null}}}let a=`${i}/product/${encodeURIComponent(t)}`,n=await s(a,{method:"GET"});if(n.json)return n.json;let l=`${i}/products/${encodeURIComponent(t)}`,d=await s(l,{method:"GET"});if(d.json)return d.json;let c=await s(l,{method:"POST"});return c.json?c.json:null}function tE(t={}){let{el:e,isTorchOn:o}={...{el:document.getElementById("torchButton"),isTorchOn:!1},...t},i=e.querySelectorAll("svg path");2===i.length&&(i[0].style.display=o?"none":"block",i[1].style.display=o?"block":"none",e.setAttribute("aria-label",`Turn ${o?"off":"on"} flash`))}function tA(t,e={}){e={duration:5e3,variant:"neutral",icon:"",...e};let o={info:`
    ...
    `}[e.icon||e.variant]||"";return Object.assign(document.createElement("alert-element"),{closable:!0,duration:e.duration,variant:e.variant,innerHTML:`${o?`<span slot="icon">${o}</span>`:""}${e.trustDangerousInnerHTML?t:function(t){let e=document.createElement("div");return e.textContent=t,e.innerHTML}(t)}`}).toast()}const tx="video-capture",tk=`
...
`;class tj extends HTMLElement{#$=null;#B=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tP.content.cloneNode(!0))}async connectedCallback(){this.#$=this.shadowRoot?.getElementById("historyList"),this.#B=this.shadowRoot?.getElementById("emptyHistoryBtn"),this.#I((await tn())[1]||[]),this.#$?.addEventListener("click",this.#D),this.#B?.addEventListener("click",this.#P)}disconnectedCallback(){this.#$?.removeEventListener("click",this.#D),this.#B?.removeEventListener("click",this.#P)}async add(t){if(!t)return;let e={type:"add",message:"Error adding barcode to history"},[o,i=[]]=await tn();if(o||!Array.isArray(i))return this.#j("bs-history-error",e),o;if(i.find(e=>e===t))return;let r=[...i,t],[s]=await tl(r);return s?(tc.error("Error setting history",s),this.#j("bs-history-error",e),s):(this.#$?.insertBefore(this.#F(t),this.#$.firstElementChild),this.#j("bs-history-success",{type:"add",message:"Barcode added to history"}),null)}async remove(t){if(!t)return;let e={type:"remove",message:"Error removing barcode from history"},[o,i=[]]=await tn();if(o||!Array.isArray(i))return this.#j("bs-history-error",e),o;let r=i.filter(e=>e!==t),[s]=await tl(r);if(s)return tc.error("Error setting history",s),this.#j("bs-history-error",e),s;let a=this.#$?.querySelector(`li[data-value="${t}"]`);return a?.remove(),this.#j("bs-history-success",{type:"remove",message:"Barcode removed from history"}),null}async empty(){let[t]=await tl([]);return t?(tc.error("Error setting history",t),this.#j("bs-history-error",{type:"empty",message:"Error emptying history"}),t):(this.#$?.replaceChildren(),this.#j("bs-history-success",{type:"empty",message:"History emptied successfully"}),null)}#I(t){if(!this.#$)return;this.#$.replaceChildren();let e=document.createDocumentFragment();[...t].reverse().forEach(t=>e.appendChild(this.#F(t))),this.#$.appendChild(e)}#F(t){let e,o=document.createElement("li");o.setAttribute("data-value",t);try{new URL(t),(e=document.createElement("a")).href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch{e=document.createElement("span")}e.textContent=t;let i=document.createElement("div");i.className="actions";let r=document.createElement("custom-clipboard-copy"),s=r.shadowRoot?.querySelector("button");r.setAttribute("only-icon",""),r.setAttribute("value",t),s?.setAttribute("aria-label",`Copy to clipboard ${t}`),i.appendChild(r);let a=document.createElement("button");return a.type="button",a.className="delete-action",a.setAttribute("data-action","delete"),a.setAttribute("aria-label",`Remove from history ${t}`),a.innerHTML=`
    ...
    `},{once:!0}),tL.defineCustomElement();let z=e?.shadowRoot,T=z?.querySelector("video"),R=z?.querySelector('[part="actions-container"]');async function M(){if(A){tc.info("Scanning..."),l?.removeAttribute("hidden");try{let[,t]=await ts(),e=await _.detect(T),o=e?.rawValue??"";if(!o)throw Error("No barcode detected");if(th(s,o),S(o,r),t?.addToHistory&&i?.add(o),tb(),!t?.continueScanning){E&&(clearTimeout(E),E=null),d?.removeAttribute("hidden"),u?.setAttribute("hidden",""),R?.setAttribute("hidden","");return}}catch{}A&&(E=setTimeout(()=>M(),1e3))}}async function q(t){if(!t)return;let[,e]=await ts(),o=new Image,r=new FileReader;r.onload=r=>{let s=r.target.result;o.onload=async()=>{try{let t=await _.detect(o),r=t?.rawValue??"";if(!r)throw Error("No barcode detected");th(n,r),S(r,a),e?.addToHistory&&i?.add(r),tb()}catch(t){tc.error(t),tA("<strong>No barcode detected</strong><br><small>Please try again with a different image.</small>",{variant:"danger",trustDangerousInnerHTML:!0}),tb({success:!1})}},o.src=s,o.alt="Image preview",c.replaceChildren();let l=document.createElement("div");l.className="dropzone-preview";let d=document.createElement("div");d.className="dropzone-preview__image-wrapper";let h=document.createElement("div");h.className="dropzone-preview__file-name",h.textContent=t.name,d.appendChild(o),l.appendChild(d),l.appendChild(h),c.prepend(l)},r.readAsDataURL(t)}async function N(t){u?.removeAttribute("hidden"),tg(t.detail.video,u),M();let o=t.target.getTrackSettings(),i=t.target.getTrackCapabilities(),r=document.getElementById("zoomLevel");if(i?.torch&&(m?.addEventListener("click",H),m?.removeAttribute("hidden"),e.hasAttribute("torch")&&tE({el:m,isTorchOn:!0})),o?.zoom&&i?.zoom){let t=document.getElementById("zoomControls"),s=i?.zoom?.min||0,a=i?.zoom?.max||10,n=o?.zoom||1;t?.addEventListener("click",t=>{let o=t.target.closest('[data-action="zoom-in"]'),i=t.target.closest('[data-action="zoom-out"]');o&&n<a&&(n+=.5),i&&n>s&&(n-=.5),r.textContent=n.toFixed(1),e.zoom=n}),t?.removeAttribute("hidden"),r.textContent=n.toFixed(1)}let s=await tL.getVideoInputDevices();s.forEach((t,e)=>{let o=document.createElement("option");o.value=t.deviceId,o.textContent=t.label||`Camera ${e+1}`,w.appendChild(o)}),s.length>1&&(w?.addEventListener("change",$),w?.removeAttribute("hidden"))}async function O(t){t.preventDefault();let e={},o=new FormData(y),i=o.getAll("general-settings"),r=o.getAll("formats-settings");i.forEach(t=>e[t]=!0),e.formats=r,ta(e),"formats-settings"===t.target.name&&(_=await tf.create(r))}function H(t){e.torch=!e.torch,tE({el:t.currentTarget,isTorchOn:e.hasAttribute("torch")})}function $(t){if("function"!=typeof e.restartVideoStream)return;let o=t.target.value||void 0;e.restartVideoStream(o)}c.accept=Z.join(","),o.supportedFormats=k,d.addEventListener("click",function(){d?.setAttribute("hidden",""),u?.removeAttribute("hidden"),R?.removeAttribute("hidden"),M()}),t.addEventListener("a-tab-show",td(function(t){let e=t.detail.tabId,o=document.querySelector("video-capture");if("cameraTab"===e){if(A=!0,!o)return;if(!o.loading&&d.hasAttribute("hidden")&&(u?.removeAttribute("hidden"),R?.removeAttribute("hidden"),M()),"function"==typeof o.startVideoStream){let t=w?.value||void 0;o.startVideoStream(t)}}else"fileTab"===e&&(A=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream(),u?.setAttribute("hidden",""),R?.setAttribute("hidden",""))},250)),c.addEventListener("files-dropzone-drop",function(t){q(t.detail.acceptedFiles[0])}),h.addEventListener("resize-observer:resize",function(){tg(e.shadowRoot.querySelector("video"),u)}),v.addEventListener("click",function(){f.open=!0}),y.addEventListener("change",td(O,500)),b.addEventListener("click",function(){g.open=!0}),document.addEventListener("visibilitychange",function(){if("cameraTab"===t.querySelector("[selected]").getAttribute("id"))if("hidden"===document.visibilityState)A=!1,null!=e&&"function"==typeof e.stopVideoStream&&e.stopVideoStream();else{A=!0;let t=document.querySelector("video-capture");if(!t)return;if(!t.loading&&d.hasAttribute("hidden")&&M(),"function"==typeof t.startVideoStream){let e=w?.value||void 0;t.startVideoStream(e)}}}),document.addEventListener("keydown",function(e){"Escape"===e.key&&function(){let e=t.querySelector("#cameraTab").hasAttribute("selected"),o=!d.hidden,i=f.hasAttribute("open"),r=g.hasAttribute("open");o&&e&&!(i||r)&&d.click()}()}),document.addEventListener("bs-history-success",function(t){let{type:e,message:o}=t.detail;"add"===e&&tA(o,{variant:"success"})}),document.addEventListener("bs-history-error",function(t){let{type:e,message:o}=t.detail;("remove"===e||"empty"===e)&&g?.hide(),tA(o,{variant:"danger"})})}();
//# sourceMappingURL=barcode-scanner-CS465.c4a4c183.js.map
