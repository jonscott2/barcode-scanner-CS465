...
`,(class t extends HTMLElement{#p=null;#r=null;#w=null;#a=void 0;#t=null;#C;static customAnimations;#e="api";constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(Y.content.cloneNode(!0))}static get observedAttributes(){return["open","duration","close-label"]}attributeChangedCallback(t,e,i){if(!(!this.isConnected||e===i))switch(t){case"open":this.#A();break;case"duration":this.#o(),this.#h()&&this.#i();break;case"close-label":this.#m()}}get closable(){return this.hasAttribute("closable")}set closable(t){this.toggleAttribute("closable",!!t)}get open(){return this.hasAttribute("open")}set open(t){this.toggleAttribute("open",!!t)}get duration(){let t=this.getAttribute("duration");if(null===t)return 1/0;let e=Number(t);return Number.isNaN(e)?1/0:e}set duration(t){this.setAttribute("duration",null!=t?t.toString():t)}get variant(){return this.getAttribute("variant")||""}set variant(t){this.setAttribute("variant",t)}get closeLabel(){return this.getAttribute("close-label")||"Close"}set closeLabel(t){this.setAttribute("close-label",null!=t?t.toString():t)}get customAnimations(){return this.#C}set customAnimations(t){this.#C=t}connectedCallback(){this.#E("closable"),this.#E("open"),this.#E("duration"),this.#E("variant"),this.#E("closeLabel"),this.#E("customAnimations"),this.#p=this.shadowRoot?.querySelector(".alert")??null,this.#r=this.shadowRoot?.querySelector(".alert__close")??null,this.#w=this.shadowRoot?.querySelector('slot[name="close"]')??null,this.#r?.addEventListener("click",this.#d),this.#w?.addEventListener("slotchange",this.#u),this.addEventListener("mouseenter",this.#l),this.addEventListener("mouseleave",this.#n),this.addEventListener("command",this.#f),this.open?(this.#p?.removeAttribute("hidden"),this.#h()&&this.#i()):this.#p?.setAttribute("hidden",""),this.closeLabel&&this.#m()}disconnectedCallback(){this.#o(),this.#r?.removeEventListener("click",this.#d),this.#w?.removeEventListener("slotchange",this.#u),this.removeEventListener("mouseenter",this.#l),this.removeEventListener("mouseleave",this.#n),this.removeEventListener("command",this.#f)}#A(){this.#o(),this.open?(this.#h()&&this.#i(),this.#p?.removeAttribute("hidden"),this.#c("alert-show"),this.#y(this.#p)?.finished.finally(()=>{this.#c(V)})):(this.#c("alert-hide",{reason:this.#e}),this.#b(this.#p)?.finished.finally(()=>{this.#p?.setAttribute("hidden",""),this.#c(U,{reason:this.#e}),this.#e="api"}))}#o(){void 0!==this.#a&&(clearTimeout(this.#a),this.#a=void 0)}#i(){this.#a=window.setTimeout(()=>{this.#e="timeout",this.open=!1},this.duration)}#h(){return this.open&&this.duration!==1/0}#d=()=>{this.closable&&(this.#e="user",this.open=!1)};#l=()=>{this.#o()};#n=()=>{this.#o(),this.#h()&&this.#i()};#u=()=>{this.#m()};#f=t=>{switch(t.command){case"--alert-show":this.open=!0;break;case"--alert-hide":this.#e="api",this.open=!1}};#m(){this.#r&&((this.#w?.assignedElements()||[])?.some(t=>t.textContent?.replace(/\s/g,"")!=="")?this.#r.removeAttribute("aria-label"):this.#r.setAttribute("aria-label",this.closeLabel))}#x(){let e=window.matchMedia("(prefers-reduced-motion: reduce)").matches,i={show:{keyframes:[{opacity:0,transform:"scale(0.9)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}},hide:{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.9)"}],options:{duration:250,easing:"ease"}}},o=this.customAnimations||t.customAnimations||{},r=r=>{let a=o[r]?.options??{},s=i[r].options;return{...s,...a,duration:e||null===this.customAnimations||null===t.customAnimations?0:a.duration??s.duration}};return{show:{keyframes:o.show?.keyframes??i.show.keyframes,options:r("show")},hide:{keyframes:o.hide?.keyframes??i.hide.keyframes,options:r("hide")}}}#y(t){let{keyframes:e,options:i}=this.#x().show;return t?.animate(e,i)}#b(t){let{keyframes:e,options:i}=this.#x().hide;return t?.animate(e,i)}#c(t,e=null){let i=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});this.dispatchEvent(i)}#s(t,e){return new Promise(i=>{t.addEventListener(e,e=>{e.target===t&&i()},{once:!0})})}show(){return this.open?Promise.resolve():(this.open=!0,this.#s(this,V))}hide(){return this.open?(this.open=!1,this.#s(this,U)):Promise.resolve()}toast(t={}){if(t={forceRestart:!1,...t},this.#t){if(!t.forceRestart)return this.#t.promise;this.#t.resolve(),this.#t.cleanup()}let e=()=>{},i=new Promise(t=>e=t),o=()=>{this.#t?.resolve(),this.#t?.cleanup()};this.#t={promise:i,resolve:e,cleanup:()=>{this.removeEventListener(U,o),this.parentNode===W&&W.removeChild(this),W.querySelector(j)||W.remove(),this.open=!1,this.#t=null}},W.parentElement||document.body.append(W),W.appendChild(this),this.#p?.setAttribute("data-toast",""),this.open=!0;let r=W.shadowRoot?.querySelector(".stack");return r?.scrollTo({top:r.scrollHeight}),this.addEventListener(U,o,{once:!0}),i}#E(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(e=j){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}}).defineCustomElement();const J=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"],K="https://api.upcdatabase.org",Z="/upc";var X=n("1ggGL");function Q(t,e=0,i=!1){let o=null;if("function"!=typeof t)throw TypeError("Expected a function for first argument");return(...r)=>{clearTimeout(o),i&&!o&&t(...r),o=setTimeout(()=>{o=null,i||t(...r)},e)}}var tt=n("9qKt3");async function te(t,e){if(!t||!e)return;let i=t.querySelector(`bs-result[value="${e}"]`);i&&i.remove();let o=document.createElement("bs-result");o.setAttribute("value",e),o.setAttribute("role","alert"),o.setAttribute("aria-live","assertive"),o.setAttribute("aria-atomic","true"),t.insertBefore(o,t.firstElementChild),t.scrollTop=0}var X=n("1ggGL");const ti=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return e=>{let{duration:i,frequency:o,volume:r,type:a,onEnded:s}=e,n=t.createOscillator(),l=t.createGain();n.connect(l),l.connect(t.destination),r&&(l.gain.value=r),o&&(n.frequency.value=o),a&&(n.type=a),"function"==typeof s&&(n.onended=s),n.start(t.currentTime),n.stop(t.currentTime+(i||500)/1e3)}})();async function to(t=0){if("function"==typeof window.navigator.vibrate)try{window.navigator.vibrate(t)}catch{}}let tr=0;async function ta(t={}){let{success:e=!0}=t,[,i]=await (0,X.getSettings)();if(!i)return;let o=Date.now();o-tr<1e3||(i.beep&&ti(e?{duration:200,frequency:860,volume:.03,type:"square"}:{duration:300,frequency:200,volume:.05,type:"sawtooth"}),i.vibrate&&to(e?100:200),tr=o)}function ts(t,e){if(!t||!e)return;let i=t.getBoundingClientRect();e.style.cssText=`width: ${i.width}px; height: ${i.height}px`}var tt=n("9qKt3");const tn=["aztec","code_128","code_39","code_93","codabar","data_matrix","ean_13","ean_8","itf","pdf417","qr_code","upc_a","upc_e"];class tl{static async polyfill(){if("BarcodeDetector"in window)tt.log.info("Using the native BarcodeDetector API.");else try{await n("3jPiW"),tt.log.info("Using BarcodeDetector polyfill.")}catch(t){throw Error("BarcodeDetector API is not supported by your browser.",{cause:t})}}static async getSupportedFormats(){let t=await window.BarcodeDetector.getSupportedFormats()||[];return tn.filter(e=>t.includes(e))}static async create(t){let e=Array.isArray(t)&&t.length>0?t:await tl.getSupportedFormats();return new tl(e)}static async setup(){try{return await tl.polyfill(),{barcodeReaderError:null}}catch(t){return{barcodeReaderError:t}}}constructor(t){this.barcodeReader=new window.BarcodeDetector({formats:t})}async detect(t){if(!this.barcodeReader)throw Error("BarcodeReader is not initialized.");let e=await this.barcodeReader.detect(t);if(Array.isArray(e)&&e.length>0){let t=e[0];return tt.log.info({rawValue:t.rawValue,format:t.format}),t}throw Error("Could not detect barcode from provided source.")}}var tt=n("9qKt3");const td=t=>t.replace(/\/+$/,"");async function tc(t){if(!t||!/^[0-9]{12,14}$/.test(t))return null;if(!K)return tt.log.info("Item info API URL not configured; skipping lookup."),null;"undefined"!=typeof window&&window?.location;let e=Z||"",i=td(e&&e.length>0?e:K),o={};async function r(t,e={}){try{let i=await fetch(t,{headers:o,...e});if(!i.ok)return{status:i.status,json:null};try{let t=await i.json();return{status:i.status,json:t}}catch(t){return tt.log.warn("Non-JSON response from item API",t),{status:i.status,json:null}}}catch(t){return tt.log.warn("Request failed",t),{status:0,json:null}}}let a=`${i}/product/${encodeURIComponent(t)}`,s=await r(a,{method:"GET"});if(s.json)return s.json;let n=`${i}/products/${encodeURIComponent(t)}`,l=await r(n,{method:"GET"});if(l.json)return l.json;let d=await r(n,{method:"POST"});return d.json?d.json:null}async function th(t){if(!t)return;let e=Z||"";if(!(e&&e.length>0))return;let i=`${td(e)}/user/ingredients`,o={"Content-Type":"application/json",Accept:"application/json"},r=localStorage.getItem("barcode-scanner/idToken");r&&(o.Authorization=`Bearer ${r}`);try{await fetch(i,{method:"DELETE",headers:o,body:JSON.stringify({title:t})})}catch(t){tt.log.error("Error removing ingredient",t)}}async function tu(){let t=Z||"";if(!(t&&t.length>0))return;let e=`${td(t)}/user/ingredients/all`,i={"Content-Type":"application/json",Accept:"application/json"},o=localStorage.getItem("barcode-scanner/idToken");o&&(i.Authorization=`Bearer ${o}`);try{await fetch(e,{method:"DELETE",headers:i})}catch(t){tt.log.error("Error removing all ingredients",t)}}function tm(t={}){let{el:e,isTorchOn:i}={...{el:document.getElementById("torchButton"),isTorchOn:!1},...t},o=e.querySelectorAll("svg path");2===o.length&&(o[0].style.display=i?"none":"block",o[1].style.display=i?"block":"none",e.setAttribute("aria-label",`Turn ${i?"off":"on"} flash`))}function tp(t,e={}){e={duration:5e3,variant:"neutral",icon:"",...e};let i={info:`
    ...
    `}[e.icon||e.variant]||"";return Object.assign(document.createElement("alert-element"),{closable:!0,duration:e.duration,variant:e.variant,innerHTML:`${i?`<span slot="icon">${i}</span>`:""}${e.trustDangerousInnerHTML?t:function(t){let e=document.createElement("div");return e.textContent=t,e.innerHTML}(t)}`}).toast()}const tb="video-capture",tg=`
...
`;class tz extends HTMLElement{constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tT.content.cloneNode(!0))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}static get observedAttributes(){return["value"]}attributeChangedCallback(t,e,i){"value"===t&&e!==i&&this.#I(this.value)}connectedCallback(){if(this.#T("value"),window.matchMedia("(prefers-reduced-motion: no-preference)").matches){let t=this.shadowRoot.querySelector(".result");t?.animate([{backgroundColor:"var(--color-flash)"},{backgroundColor:"transparent"}],{duration:400,easing:"ease-out"})}if(!tL()){let t=this.shadowRoot.querySelector("web-share");t&&(t.hidden=!0)}}async #I(t){let e,i=this.shadowRoot.querySelector(".result"),o=i?.querySelector(".result__content"),r=i?.querySelector(".result__datetime"),a=i?.querySelector(".result__item");a&&a?.remove();try{let[,i]=await (0,X.getSettings)();new URL(t),(e=document.createElement("a")).href=t,i?.openWebPageSameTab||(e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")),i?.openWebPage?e.click():window.requestAnimationFrame(()=>e.focus())}catch{e=document.createElement("span")}e.className="result__item",e.part="result__item",e.textContent=t;let s=i.querySelector(".result__meta");if(s){s.textContent="";let t=this.getAttribute("data-title")||"",e=this.getAttribute("data-brand")||"",i=this.getAttribute("data-description")||"";if(t){let e=document.createElement("div");e.className="result__meta-title",e.textContent=t,s.appendChild(e)}if(e){let t=document.createElement("div");t.className="result__meta-brand",t.textContent=`Brand: ${e}`,s.appendChild(t)}if(i){let t=document.createElement("div");t.className="result__meta-description",t.textContent=i,s.appendChild(t)}}r.textContent=tS.format(new Date),o?.insertBefore(e,r);let n=i?.querySelector("custom-clipboard-copy"),l=i?.querySelector("web-share");if(n){let e=n.shadowRoot?.querySelector("button");n.setAttribute("value",t),e?.setAttribute("aria-label",`Copy to clipboard ${t}`),n.hidden=!1}if(l&&tL()){let e=l.querySelector("button");l.setAttribute("share-text",t),l.hidden=!1,e?.setAttribute("aria-label",`Share ${t}`)}}#T(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-result"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tz)}}tz.defineCustomElement();var X=n("1ggGL");class tI extends HTMLElement{#R=null;#N=null;#D=[];#M;constructor(){super()}get supportedFormats(){return this.#D}set supportedFormats(t){this.#D=t,this.#F()}async connectedCallback(){this.#T("supportedFormats"),this.#R=this.querySelector("#formatsList"),this.#N=this.querySelector("form");let[,t]=await (0,X.getSettings)();this.#M=t??{},this.#N?.querySelectorAll('[name="general-settings"]').forEach(t=>{t.checked=this.#M[t.value]})}#F(){if(!this.#R)return;let t=this.#M?.formats;this.#R.replaceChildren(),this.supportedFormats.forEach(e=>{let i=document.createElement("li"),o=document.createElement("label"),r=document.createElement("input");r.type="checkbox",r.name="formats-settings",r.value=e,r.checked=null==t||t.includes(e),o.appendChild(r),o.appendChild(document.createTextNode(e)),i.appendChild(o),this.#R.appendChild(i)})}#T(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-settings"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tI)}}tI.defineCustomElement();var X=n("1ggGL"),tR=n("ftYLF"),tN=n("ccbGL"),tD=n("iW3id"),tt=n("9qKt3"),X=n("1ggGL");const tM="scans";async function tF(){if(!(0,tN.isFirebaseConfigured)()||!tN.db)return tt.log.warn("Firestore not configured. Running in local-only mode."),{error:null};try{return await (0,tR.enableIndexedDbPersistence)(tN.db),tt.log.info("Firestore offline persistence enabled"),{error:null}}catch(t){return"failed-precondition"===t.code?tt.log.warn("Firestore persistence failed: Multiple tabs open"):"unimplemented"===t.code?tt.log.warn("Firestore persistence not supported in this browser"):tt.log.error("Error enabling Firestore persistence:",t),{error:t}}}async function tB(t){let e=(0,tD.getUserId)();if(!(0,tN.isFirebaseConfigured)()||!tN.db||!e){tt.log.info("Saving scan locally (Firebase not available or user not authenticated)");try{let[,e=[]]=await (0,X.getHistory)(),i={value:t.value,addedAt:Date.now(),expiresAt:Date.now()+6048e5,notified:!1,preNotified:!1,title:t.title||"",brand:t.brand||"",description:t.description||"",format:t.format||"",metadata:t.metadata||{}};return await (0,X.setHistory)([...e,i]),{error:null,scanId:null}}catch(t){return tt.log.error("Error saving scan locally:",t),{error:t,scanId:null}}}try{let i={userId:e,value:t.value,format:t.format||"",title:t.title||"",brand:t.brand||"",description:t.description||"",metadata:t.metadata||{},scannedAt:tR.Timestamp.now(),createdAt:tR.Timestamp.now(),updatedAt:tR.Timestamp.now()},o=await (0,tR.addDoc)((0,tR.collection)(tN.db,tM),i);tt.log.info("Scan saved to Firestore:",o.id);try{let[,e=[]]=await (0,X.getHistory)(),i={value:t.value,addedAt:Date.now(),expiresAt:Date.now()+6048e5,notified:!1,preNotified:!1,title:t.title||"",brand:t.brand||"",description:t.description||"",format:t.format||"",firestoreId:o.id};await (0,X.setHistory)([...e,i])}catch(t){tt.log.warn("Error saving to local storage:",t)}return{error:null,scanId:o.id}}catch(e){tt.log.error("Error saving scan to Firestore:",e);try{let[,e=[]]=await (0,X.getHistory)(),i={value:t.value,addedAt:Date.now(),expiresAt:Date.now()+6048e5,notified:!1,preNotified:!1,title:t.title||"",brand:t.brand||"",description:t.description||"",format:t.format||"",pendingSync:!0};await (0,X.setHistory)([...e,i]),tt.log.info("Scan saved locally, will sync when online")}catch(t){tt.log.error("Error saving to local storage:",t)}return{error:e,scanId:null}}}async function tq(t=100){let e=(0,tD.getUserId)();if(!(0,tN.isFirebaseConfigured)()||!tN.db||!e){tt.log.info("Getting scans from local storage (Firebase not available or user not authenticated)");try{let[t,e=[]]=await (0,X.getHistory)();if(t)return{error:t,scans:[]};let i=e.map(t=>({id:t.firestoreId||null,value:"string"==typeof t?t:t.value,title:t.title||"",brand:t.brand||"",description:t.description||"",format:t.format||"",scannedAt:t.addedAt?new Date(t.addedAt):new Date,metadata:t.metadata||{}}));return{error:null,scans:i}}catch(t){return tt.log.error("Error getting scans from local storage:",t),{error:t,scans:[]}}}try{let i=(0,tR.query)((0,tR.collection)(tN.db,tM),(0,tR.where)("userId","==",e),(0,tR.orderBy)("scannedAt","desc"),(0,tR.limit)(t)),o=await (0,tR.getDocs)(i),r=[];return o.forEach(t=>{r.push({id:t.id,...t.data(),scannedAt:t.data().scannedAt?.toDate()||new Date})}),tt.log.info(`Retrieved ${r.length} scans from Firestore`),{error:null,scans:r}}catch(t){tt.log.error("Error getting scans from Firestore:",t);try{let[t,e=[]]=await (0,X.getHistory)();if(!t){let t=e.map(t=>({id:t.firestoreId||null,value:"string"==typeof t?t:t.value,title:t.title||"",brand:t.brand||"",description:t.description||"",format:t.format||"",scannedAt:t.addedAt?new Date(t.addedAt):new Date,metadata:t.metadata||{}}));return tt.log.info("Returning scans from local storage (Firestore unavailable)"),{error:null,scans:t}}}catch(t){tt.log.error("Error getting scans from local storage:",t)}return{error:t,scans:[]}}}async function t$(t){let e=(0,tD.getUserId)();if(!(0,tN.isFirebaseConfigured)()||!tN.db||!e||!t)return tt.log.info("Deleting scan from local storage only"),{error:null};try{return await (0,tR.deleteDoc)((0,tR.doc)(tN.db,tM,t)),tt.log.info("Scan deleted from Firestore:",t),{error:null}}catch(t){return tt.log.error("Error deleting scan from Firestore:",t),{error:t}}}async function tH(){let t=(0,tD.getUserId)();if(!(0,tN.isFirebaseConfigured)()||!tN.db||!t){tt.log.info("Deleting all scans from local storage only");try{return await (0,X.setHistory)([]),{error:null,deletedCount:0}}catch(t){return{error:t,deletedCount:0}}}try{let e=(0,tR.query)((0,tR.collection)(tN.db,tM),(0,tR.where)("userId","==",t)),i=await (0,tR.getDocs)(e),o=(0,tR.writeBatch)(tN.db),r=0;i.forEach(t=>{o.delete(t.ref),r++}),await o.commit(),tt.log.info(`Deleted ${r} scans from Firestore`);try{await (0,X.setHistory)([])}catch(t){tt.log.warn("Error clearing local storage:",t)}return{error:null,deletedCount:r}}catch(t){return tt.log.error("Error deleting all scans from Firestore:",t),{error:t,deletedCount:0}}}async function tO(){let t=(0,tD.getUserId)();if(!(0,tN.isFirebaseConfigured)()||!tN.db||!t)return{error:Error("Firebase not configured or user not authenticated"),syncedCount:0};try{let[t,e=[]]=await (0,X.getHistory)();if(t)return{error:t,syncedCount:0};let i=e.filter(t=>!0===t.pendingSync);if(0===i.length)return{error:null,syncedCount:0};let o=0,r=[...e];for(let t of i)try{let e=await tB({value:t.value,title:t.title,brand:t.brand,description:t.description,format:t.format,metadata:t.metadata});if(!e.error&&e.scanId){let i=r.findIndex(e=>e===t);-1!==i&&(r[i]={...r[i],firestoreId:e.scanId,pendingSync:!1}),o++}}catch(t){tt.log.error("Error syncing individual scan:",t)}return await (0,X.setHistory)(r),tt.log.info(`Synced ${o} pending scans to Firestore`),{error:null,syncedCount:o}}catch(t){return tt.log.error("Error syncing pending scans:",t),{error:t,syncedCount:0}}}var tN=n("ccbGL"),tD=n("iW3id"),tt=n("9qKt3");const tP=`
  :host {
...
`;class tV extends HTMLElement{#B=null;#q=null;#$=864e5;static #H=6048e5;static #O(){try{let t=new URLSearchParams(window.location.search),e=t.get("testExpireSeconds"),i=e?Number(e):NaN;if(!Number.isNaN(i)&&i>0)return 1e3*i;let o=t.get("testMode");if("1"===o||"true"===String(o).toLowerCase())return 1e4}catch(t){}return tV.#H}constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tj.content.cloneNode(!0))}async connectedCallback(){this.#B=this.shadowRoot?.getElementById("historyList"),this.#q=this.shadowRoot?.getElementById("emptyHistoryBtn");let[,t=[]]=await (0,X.getHistory)(),e=[],i=!1;try{if("function"==typeof tN.isFirebaseConfigured&&"function"==typeof tD.isAuthenticated&&(0,tN.isFirebaseConfigured)()&&(0,tD.isAuthenticated)()){i=!0;let{error:o,scans:r}=await tq();if(!o&&r){let i=r.map(t=>({value:t.value||"",addedAt:t.scannedAt?t.scannedAt.getTime():Date.now(),expiresAt:t.scannedAt?t.scannedAt.getTime()+tV.#O():Date.now()+tV.#O(),notified:!1,preNotified:!1,title:t.title||"",brand:t.brand||"",description:t.description||"",format:t.format||"",firestoreId:t.id||null}));tt.log.info(`Loaded ${i.length} scans from Firestore`);let o=(t||[]).map(t=>{if(!t)return null;if("string"==typeof t){let e=Date.now();return{value:t,addedAt:e,expiresAt:e+tV.#O(),notified:!1,preNotified:!1}}return{value:t.value??t?.barcode??"",addedAt:t.addedAt??Date.now(),expiresAt:t.expiresAt??(t.addedAt?t.addedAt+tV.#O():Date.now()+tV.#O()),notified:!!t.notified,preNotified:!!t.preNotified,title:t.title||"",brand:t.brand||"",description:t.description||"",format:t.format||"",firestoreId:t.firestoreId||null}}).filter(Boolean),a=new Map;i.forEach(t=>{a.set(t.value,t)}),o.forEach(t=>{a.has(t.value)||a.set(t.value,t)}),e=Array.from(a.values())}}}catch(t){tt.log.error("Firebase not available or error loading from Firestore:",t),i=!1}if(!i||0===e.length){let i=(t||[]).map(t=>{if(!t)return null;if("string"==typeof t){let e=Date.now();return{value:t,addedAt:e,expiresAt:e+tV.#O(),notified:!1,preNotified:!1}}return{value:t.value??t?.barcode??"",addedAt:t.addedAt??Date.now(),expiresAt:t.expiresAt??(t.addedAt?t.addedAt+tV.#O():Date.now()+tV.#O()),notified:!!t.notified,preNotified:!!t.preNotified,title:t.title||"",brand:t.brand||"",description:t.description||"",format:t.format||"",firestoreId:t.firestoreId||null}}).filter(Boolean);e=i,await (0,X.setHistory)(i)}this.#P(e||[]);try{let t=new URLSearchParams(window.location.search),e=t.get("testExpireSeconds"),i=t.get("testMode");if(e||i){let t=e?String(Number(e)):"10";try{tp(`Test expiry active: items expire in ${t} second${"1"===t?"":"s"}`,{variant:"warning"})}catch(t){}}}catch(t){}this.#B?.addEventListener("click",this.#j),this.#q?.addEventListener("click",this.#V),this.#U()}disconnectedCallback(){this.#B?.removeEventListener("click",this.#j),this.#q?.removeEventListener("click",this.#V),this.#W()}async add(t){if(!t)return;let e={type:"add",message:"Error adding barcode to history"},[i,o=[]]=await (0,X.getHistory)();if(i||!Array.isArray(o))return this.#G("bs-history-error",e),i;let r=(o||[]).map(t=>"string"==typeof t?{value:t,addedAt:Date.now(),expiresAt:Date.now()+tV.#O(),notified:!1,preNotified:!1}:{value:t.value??t.barcode??"",addedAt:t.addedAt??Date.now(),expiresAt:t.expiresAt??(t.addedAt?t.addedAt+tV.#O():Date.now()+tV.#O()),notified:!!t.notified,preNotified:!!t.preNotified}),a="string"==typeof t?t:t.value,s=r.find(t=>t.value===a);if(s){try{let t=tV.#O();if(t<tV.#H){s.expiresAt=Date.now()+t,s.notified=!1,s.preNotified=!1;let[e]=await (0,X.setHistory)(r);if(!e){let t=this.#B?.querySelector(`li[data-value="${a}"]`);if(t){let e=t.querySelector(".history-countdown");e&&(e.dataset.expiresAt=String(s.expiresAt),e.textContent=this.#Y(s.expiresAt-Date.now()))}this.#G("bs-history-success",{type:"add",message:"Barcode expiry refreshed for testing"}),this.#J()}return null}}catch(t){}return}let n=Date.now(),l={value:a,addedAt:n,expiresAt:n+tV.#O(),notified:!1,preNotified:!1},d=[...r,l],[c]=await (0,X.setHistory)(d);if(c)return tt.log.error("Error setting history",c),this.#G("bs-history-error",e),c;this.#B?.insertBefore(this.#K(l),this.#B.firstElementChild);try{let t=new Date(l.expiresAt),e=Math.round((l.expiresAt-Date.now())/864e5);tp(`Expires on ${t.toLocaleString()} (~${e} day${1===e?"":"s"})`,{variant:"info"})}catch(t){}return this.#G("bs-history-success",{type:"add",message:"Barcode added to history"}),this.#J(),null}async remove(t){if(!t)return;let e={type:"remove",message:"Error removing barcode from history"};try{if("function"==typeof tN.isFirebaseConfigured&&"function"==typeof tD.isAuthenticated&&(0,tN.isFirebaseConfigured)()&&(0,tD.isAuthenticated)()){let e=this.#B?.querySelector(`li[data-value="${t}"]`),i=e?.dataset.firestoreId;if(i&&1){let{error:t}=await t$(i);t&&tt.log.error("Error deleting scan from Firestore:",t)}}}catch(t){tt.log.error("Firebase not available:",t)}let[i,o=[]]=await (0,X.getHistory)();if(i||!Array.isArray(o))return this.#G("bs-history-error",e),i;let r=(o||[]).filter(e=>"string"==typeof e?e!==t:e.value!==t),[a]=await (0,X.setHistory)(r);if(a)return tt.log.error("Error setting history",a),this.#G("bs-history-error",e),a;let s=this.#B?.querySelector(`li[data-value="${t}"]`),n=s?.getAttribute("data-title");return n&&th(n).catch(t=>tt.log.warn("Failed to remove ingredient from server",t)),s?.remove(),this.#G("bs-history-success",{type:"remove",message:"Barcode removed from history"}),this.#J(),null}async empty(){try{if("function"==typeof tN.isFirebaseConfigured&&"function"==typeof tD.isAuthenticated&&(0,tN.isFirebaseConfigured)()&&(0,tD.isAuthenticated)()&&1){let{error:t,deletedCount:e}=await tH();t?tt.log.error("Error deleting all scans from Firestore:",t):tt.log.info(`Deleted ${e} scans from Firestore`)}}catch(t){tt.log.error("Firebase not available:",t)}let[t]=await (0,X.setHistory)([]);return t?(tt.log.error("Error setting history",t),this.#G("bs-history-error",{type:"empty",message:"Error emptying history"}),t):(tu().catch(t=>tt.log.warn("Failed to remove all ingredients from server",t)),this.#B?.replaceChildren(),this.#G("bs-history-success",{type:"empty",message:"History emptied successfully"}),this.#J(),null)}async loadHistory(){let[,t=[]]=await (0,X.getHistory)(),e=[],i=!1;try{if("function"==typeof tN.isFirebaseConfigured&&"function"==typeof tD.isAuthenticated&&(0,tN.isFirebaseConfigured)()&&(0,tD.isAuthenticated)()){i=!0;let{error:o,scans:r}=await tq();if(!o&&r){let i=r.map(t=>({value:t.value||"",addedAt:t.scannedAt?t.scannedAt.getTime():Date.now(),expiresAt:t.scannedAt?t.scannedAt.getTime()+tV.#O():Date.now()+tV.#O(),notified:!1,preNotified:!1,title:t.title||"",brand:t.brand||"",description:t.description||"",format:t.format||"",firestoreId:t.id||null})),o=(t||[]).map(t=>{if(!t)return null;if("string"==typeof t){let e=Date.now();return{value:t,addedAt:e,expiresAt:e+tV.#O(),notified:!1,preNotified:!1}}return{value:t.value??t?.barcode??"",addedAt:t.addedAt??Date.now(),expiresAt:t.expiresAt??(t.addedAt?t.addedAt+tV.#O():Date.now()+tV.#O()),notified:!!t.notified,preNotified:!!t.preNotified,title:t.title||"",brand:t.brand||"",description:t.description||"",format:t.format||"",firestoreId:t.firestoreId||null}}).filter(Boolean),a=new Map;i.forEach(t=>{a.set(t.value,t)}),o.forEach(t=>{a.has(t.value)||a.set(t.value,t)}),e=Array.from(a.values())}}}catch(t){tt.log.error("Firebase not available or error loading:",t),i=!1}if(!i||0===e.length){let i=(t||[]).map(t=>{if(!t)return null;if("string"==typeof t){let e=Date.now();return{value:t,addedAt:e,expiresAt:e+tV.#O(),notified:!1,preNotified:!1}}return{value:t.value??t?.barcode??"",addedAt:t.addedAt??Date.now(),expiresAt:t.expiresAt??(t.addedAt?t.addedAt+tV.#O():Date.now()+tV.#O()),notified:!!t.notified,preNotified:!!t.preNotified,title:t.title||"",brand:t.brand||"",description:t.description||"",format:t.format||"",firestoreId:t.firestoreId||null}}).filter(Boolean);e=i,await (0,X.setHistory)(i)}this.#P(e||[])}#P(t){if(!this.#B)return;this.#B.replaceChildren();let e=document.createDocumentFragment();[...t].reverse().forEach(t=>e.appendChild(this.#K(t))),this.#B.appendChild(e)}#K(t){let e,i=document.createElement("li"),o="string"==typeof t?t:t.value||"",r=t?.expiresAt||Date.now()+tV.#O(),a=t?.firestoreId||null,s=t?.title||"",n=t?.brand||"",l=t?.description||"";i.setAttribute("data-value",o),a&&i.setAttribute("data-firestore-id",a),s&&i.setAttribute("data-title",s),n&&i.setAttribute("data-brand",n),l&&i.setAttribute("data-description",l);try{new URL(o),(e=document.createElement("a")).href=o,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch{(e=document.createElement("span")).className="history-item-clickable",e.setAttribute("data-action","view-details")}s?e.innerHTML=`<strong>${s}</strong><br><small>${o}</small>`:e.textContent=o;let d=document.createElement("span");d.className="history-countdown",d.setAttribute("aria-live","polite"),d.dataset.expiresAt=String(r),d.textContent=this.#Y(r-Date.now()),i.appendChild(e),i.appendChild(d);let c=document.createElement("div");c.className="actions";let h=document.createElement("custom-clipboard-copy"),u=h.shadowRoot?.querySelector("button");h.setAttribute("only-icon",""),h.setAttribute("value",o),u?.setAttribute("aria-label",`Copy to clipboard ${o}`),c.appendChild(h);let m=document.createElement("button");return m.type="button",m.className="delete-action",m.setAttribute("data-action","delete"),m.setAttribute("aria-label",`Remove from history ${o}`),m.innerHTML=`
...
(No product information available)`);return}};#Z=null;#U(){this.#Z||(this.#Z=setInterval(()=>this.#J(),1e3),this.#J())}#W(){this.#Z&&(clearInterval(this.#Z),this.#Z=null)}async #J(){try{let[,t=[]]=await (0,X.getHistory)(),e=(t||[]).map(t=>"string"==typeof t?{value:t,addedAt:Date.now(),expiresAt:Date.now()+tV.#O(),notified:!1,preNotified:!1}:{value:t.value??t.barcode??"",addedAt:t.addedAt??Date.now(),expiresAt:t.expiresAt??(t.addedAt?t.addedAt+tV.#O():Date.now()+tV.#O()),notified:!!t.notified,preNotified:!!t.preNotified}),i=Date.now(),o=tV.#O(),r=this.#$;try{o<this.#$&&(r=Math.max(1e3,Math.floor(.2*o)))}catch(t){r=this.#$}(this.shadowRoot?.querySelectorAll(".history-countdown")||[]).forEach(t=>{let e=Number(t.dataset.expiresAt)||i;t.textContent=this.#Y(e-i)});let a=!1,s=e.filter(t=>t&&(t.expiresAt||0)-i>0&&(t.expiresAt||0)-i<=r&&!t.preNotified).length;for(let t of e){if(!t)continue;let e=(t.expiresAt||0)-i;e>0&&e<=r&&!t.preNotified&&(this.#X(t,e,s),t.preNotified=!0,a=!0),e<=0&&!t.notified&&(this.#Q(t),t.notified=!0,a=!0)}a&&await (0,X.setHistory)(e)}catch(t){}}async #X(t,e,i=1){try{let o=`${t.value} will expire in ${this.#Y(e)}.`;Number.isFinite(i)&&i>0&&(1===i?o+=" You have one more item that will expire soon; the next notification will be when it expires.":i>1&&(o+=` You have ${i} items that will expire soon.`));try{tp(o,{variant:"warning"})}catch(t){}"Notification"in window&&("default"===Notification.permission&&await Notification.requestPermission(),"granted"===Notification.permission&&new Notification("Item will expire soon",{body:o}))}catch(t){}}#Y(t){if(t<=0)return"Expired";let e=Math.floor(t/1e3),i=Math.floor(e/86400),o=Math.floor(e%86400/3600),r=Math.floor(e%3600/60),a=e%60;return i>0?`${i}d ${o}h ${r}m left`:o>0?`${o}h ${r}m ${a}s left`:r>0?`${r}m ${a}s left`:`${a}s left`}async #Q(t){try{let e=`${t.value} has expired.`;try{tp(e,{variant:"danger"})}catch(t){}"Notification"in window&&("default"===Notification.permission&&await Notification.requestPermission(),"granted"===Notification.permission&&new Notification("Item expired",{body:e}))}catch(t){}}#V=async()=>{window.confirm("Empty history? This action cannot be undone.")&&this.empty()};#G(t,e=null){let i=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});this.dispatchEvent(i)}static defineCustomElement(t="bs-history"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tV)}}tV.defineCustomElement();var tN=n("ccbGL"),tD=n("iW3id"),tt=n("9qKt3");const tU=`
  :host {
    display: block;
    box-sizing: border-box;
  }
...
`;class tG extends HTMLElement{#tt=null;#te=null;#ti=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tW.content.cloneNode(!0))}connectedCallback(){this.#tt=this.shadowRoot.getElementById("authStatus"),this.#te=this.shadowRoot.getElementById("authForms"),this.#to();let t=this.shadowRoot.getElementById("firebaseConfigureBtn"),e=this.shadowRoot.getElementById("firebaseClearBtn");t&&t.addEventListener("click",()=>this.#tr()),e&&e.addEventListener("click",()=>this.#ta()),this.#ti=(0,tD.onAuthStateChange)(t=>{this.#ts(t)});let i=(0,tD.getCurrentUser)();this.#ts(i)}disconnectedCallback(){this.#ti&&this.#ti()}#to(){this.shadowRoot.querySelectorAll(".auth-tab").forEach(t=>{t.addEventListener("click",()=>this.#tn(t.dataset.tab))}),this.shadowRoot.getElementById("anonymousBtn")?.addEventListener("click",()=>this.#tl()),this.shadowRoot.getElementById("signinAnonymousBtn")?.addEventListener("click",()=>this.#tl()),this.shadowRoot.getElementById("signupAnonymousBtn")?.addEventListener("click",()=>this.#tl()),this.shadowRoot.getElementById("signinForm")?.addEventListener("submit",t=>this.#td(t)),this.shadowRoot.getElementById("signupForm")?.addEventListener("submit",t=>this.#tc(t)),this.shadowRoot.getElementById("signOutBtn")?.addEventListener("click",()=>this.#th())}#tn(t){let e=this.shadowRoot.querySelectorAll(".auth-tab"),i=this.shadowRoot.querySelectorAll(".auth-form");e.forEach(e=>{e.dataset.tab===t?e.classList.add("active"):e.classList.remove("active")}),i.forEach(e=>{e.id===`${t}Form`?e.classList.add("active"):e.classList.remove("active")})}async #tl(){let t=this.shadowRoot.getElementById("anonymousBtn");t&&(t.disabled=!0);let{error:e,user:i}=await (0,tD.signInAnonymous)();e?(tt.log.error("Error signing in anonymously:",e),tp("Error signing in. Please try again.",{variant:"danger"}),t&&(t.disabled=!1)):tp("Signed in successfully!",{variant:"success"})}async #td(t){t.preventDefault();let e=this.shadowRoot.getElementById("signinEmail"),i=this.shadowRoot.getElementById("signinPassword"),o=this.shadowRoot.getElementById("signinError"),r=this.shadowRoot.getElementById("signinBtn");r&&(r.disabled=!0),o&&(o.hidden=!0);let{error:a,user:s}=await (0,tD.signInWithEmail)(e.value,i.value);a?(tt.log.error("Error signing in:",a),o&&(o.textContent=this.#tu(a),o.hidden=!1),r&&(r.disabled=!1)):(tp("Signed in successfully!",{variant:"success"}),i.value="")}async #tc(t){t.preventDefault();let e=this.shadowRoot.getElementById("signupEmail"),i=this.shadowRoot.getElementById("signupPassword"),o=this.shadowRoot.getElementById("signupDisplayName"),r=this.shadowRoot.getElementById("signupError"),a=this.shadowRoot.getElementById("signupBtn");a&&(a.disabled=!0),r&&(r.hidden=!0);let{error:s,user:n}=await (0,tD.createAccount)(e.value,i.value,o.value);s?(tt.log.error("Error creating account:",s),r&&(r.textContent=this.#tu(s),r.hidden=!1),a&&(a.disabled=!1)):(tp("Account created successfully!",{variant:"success"}),i.value="")}async #th(){let t=this.shadowRoot.getElementById("signOutBtn");t&&(t.disabled=!0);let{error:e}=await (0,tD.signOut)();e?(tt.log.error("Error signing out:",e),tp("Error signing out. Please try again.",{variant:"danger"}),t&&(t.disabled=!1)):tp("Signed out successfully",{variant:"success"})}async #tr(){let t=this.shadowRoot.getElementById("firebaseConfigInput");if(!t)return;let e=t.value.trim();if(!e)return void tp("Please paste your Firebase config JSON first",{variant:"warning"});let i=null;try{i=JSON.parse(e)}catch(t){tp("Invalid JSON. Please check and try again.",{variant:"danger"});return}let{error:o}=(0,tN.initFirebaseRuntime)(i);if(o){tt.log.error("Error initializing Firebase with provided config:",o),tp("Failed to initialize Firebase. Check console for details.",{variant:"danger"});return}try{await tF()}catch(t){}try{await (0,tD.initAuth)()||await (0,tD.signInAnonymous)()}catch(t){}try{this.#ti&&this.#ti(),this.#ti=(0,tD.onAuthStateChange)(t=>this.#ts(t))}catch(t){}this.shadowRoot.getElementById("firebaseNotConfigured")?.setAttribute("hidden",""),tp("Firebase configured successfully",{variant:"success"});let r=this.shadowRoot.getElementById("signinBtn"),a=this.shadowRoot.getElementById("signupBtn");r&&(r.disabled=!1),a&&(a.disabled=!1)}#ta(){let t=this.shadowRoot.getElementById("firebaseConfigInput");t&&(t.value="")}#ts(t){if(t){this.#tt?.removeAttribute("hidden"),this.#te?.setAttribute("hidden","");let e=this.shadowRoot.getElementById("userIcon"),i=this.shadowRoot.getElementById("userEmail"),o=this.shadowRoot.getElementById("userType");e&&(e.textContent=t.email?t.email[0].toUpperCase():"?"),i&&(i.textContent=t.email||"Anonymous User"),o&&(o.textContent=t.isAnonymous?"Anonymous Account":"Email Account"),this.dispatchEvent(new CustomEvent("auth-state-changed",{bubbles:!0,composed:!0,detail:{user:t}}))}else this.#tt?.setAttribute("hidden",""),this.#te?.removeAttribute("hidden"),this.dispatchEvent(new CustomEvent("auth-state-changed",{bubbles:!0,composed:!0,detail:{user:null}}))}#tu(t){switch(t.code){case"auth/email-already-in-use":return"This email is already in use. Please sign in or use a different email.";case"auth/invalid-email":return"Invalid email address.";case"auth/weak-password":return"Password should be at least 6 characters.";case"auth/user-not-found":return"No account found with this email.";case"auth/wrong-password":return"Incorrect password.";case"auth/too-many-requests":return"Too many failed attempts. Please try again later.";case"auth/network-request-failed":return"Network error. Please check your connection.";default:return t.message||"An error occurred. Please try again."}}static defineCustomElement(t="bs-auth"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tG)}}tG.defineCustomElement();var tD=n("iW3id"),tN=n("ccbGL");!async function(){try{try{(0,tN.initFirebaseRuntime)()}catch(t){}if((0,tN.isFirebaseConfigured)()){tt.log.info("Initializing Firebase..."),await tF(),await (0,tD.initAuth)()||(tt.log.info("No user signed in, signing in anonymously..."),await (0,tD.signInAnonymous)());let{syncedCount:t}=await tO();t>0&&tp(`Synced ${t} scans from offline mode`,{variant:"success"}),window.addEventListener("online",async()=>{tt.log.info("Back online, syncing pending scans...");let{syncedCount:t}=await tO();t>0&&tp(`Synced ${t} scans`,{variant:"success"})}),window.addEventListener("offline",()=>{tt.log.info("Offline mode - scans will be saved locally"),tp("Offline mode - scans will sync when online",{variant:"warning"})})}else tt.log.info("Firebase not configured - using local storage only")}catch(t){tt.log.error("Error initializing Firebase:",t),tp("Running in offline mode",{variant:"warning"})}let t=document.querySelector("a-tab-group"),e=document.querySelector("video-capture"),i=document.querySelector("bs-settings"),o=document.querySelector("bs-history"),r=document.getElementById("cameraPanel"),a=r.querySelector(".results"),s=document.getElementById("filePanel"),n=s.querySelector(".results"),l=document.getElementById("scanInstructions"),d=document.getElementById("scanBtn"),c=document.getElementById("dropzone"),h=document.querySelector("resize-observer"),u=document.getElementById("scanFrame"),m=document.getElementById("torchButton"),p=document.getElementById("globalActions"),b=document.getElementById("authBtn"),g=document.getElementById("authDialog"),f=document.getElementById("historyBtn"),v=document.getElementById("historyDialog"),y=document.getElementById("settingsBtn"),w=document.getElementById("settingsDialog"),E=document.getElementById("settingsForm"),A=document.getElementById("cameraSelect"),x=null,C=!0;"function"==typeof HTMLDialogElement&&(p?.removeAttribute("hidden"),g?.removeAttribute("hidden"),v?.removeAttribute("hidden"),w?.removeAttribute("hidden"));let{barcodeReaderError:k}=await tl.setup();if(k){let e=document.getElementById("barcodeReaderError");C=!1,p?.setAttribute("hidden",""),t?.setAttribute("hidden",""),e?.setAttribute("open","");return}let L=await tl.getSupportedFormats(),[,S]=await (0,X.getSettings)(),_=S?.formats||L,T=await tl.create(_);async function z(t,e,i=""){try{let o=await tc(t);if(o){let r=o.title||o.name||o.alias||"",a=o.description||o.brand||"",s=`${r||t}${a?` \u{2014} ${a}`:""}`;tp(s,{variant:"success"}),function(t,e){if(!t||!e)return;let i=t.querySelector("#itemInfo");if(!i){(i=document.createElement("div")).id="itemInfo",i.className="item-info";let e=t.querySelector(".results");e&&e.parentNode?e.parentNode.insertBefore(i,e.nextSibling):t.appendChild(i)}i.textContent="";let o=document.createElement("h3");o.className="item-info__title",o.textContent=e.title||e.name||e.alias||"";let r=document.createElement("p");r.className="item-info__description",r.textContent=e.description||"";let a=document.createElement("p");a.className="item-info__brand",a.textContent=e.brand?`Brand: ${e.brand}`:"",i.appendChild(o),r.textContent&&i.appendChild(r),a.textContent&&i.appendChild(a)}(e,o);try{let i=e?.querySelector(".results");if(i){let e=i.querySelector(`bs-result[value="${t}"]`);e&&(o.title&&e.setAttribute("data-title",o.title),o.brand&&e.setAttribute("data-brand",o.brand),o.description&&e.setAttribute("data-description",o.description))}}catch(t){}try{await tB({value:t,format:i,title:o.title||o.name||o.alias||"",brand:o.brand||"",description:o.description||"",metadata:{source:"camera",hasProductInfo:!0}})}catch(t){tt.log.warn("Error saving scan to Firestore:",t)}return o}try{await tB({value:t,format:i,metadata:{source:"camera",hasProductInfo:!1}})}catch(t){tt.log.warn("Error saving scan to Firestore:",t)}}catch(e){try{await tB({value:t,format:i,metadata:{source:"camera",hasProductInfo:!1,lookupFailed:!0}})}catch(t){tt.log.warn("Error saving scan to Firestore:",t)}}}e.addEventListener("video-capture:video-play",F,{once:!0}),e.addEventListener("video-capture:error",function(t){let e=t.detail.error;if("NotFoundError"===e.name)return;let i="NotAllowedError"===e.name?"<strong>Error accessing camera</strong><br>Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;r.innerHTML=`
    ...
    `},{once:!0}),tv.defineCustomElement();let I=e?.shadowRoot,R=I?.querySelector("video"),N=I?.querySelector('[part="actions-container"]');async function D(){if(C){tt.log.info("Scanning..."),l?.removeAttribute("hidden");try{let[,t]=await (0,X.getSettings)(),e=await T.detect(R),i=e?.rawValue??"",s=e?.format??"";if(!i)throw Error("No barcode detected");if(te(a,i),z(i,r,s),t?.addToHistory)try{await o?.add(i),v&&(v.open=!0,setTimeout(()=>{try{let t=o?.shadowRoot?.querySelector(`li[data-value="${i}"]`);t?.scrollIntoView({behavior:"smooth",block:"center"}),t?.classList?.add("highlight"),setTimeout(()=>t?.classList?.remove("highlight"),2e3)}catch(t){}},50))}catch(t){}if(ta(),!t?.continueScanning){x&&(clearTimeout(x),x=null),d?.removeAttribute("hidden"),u?.setAttribute("hidden",""),N?.setAttribute("hidden","");return}}catch{}C&&(x=setTimeout(()=>D(),1e3))}}async function M(t){if(!t)return;let[,e]=await (0,X.getSettings)(),i=new Image,r=new FileReader;r.onload=r=>{let a=r.target.result;i.onload=async()=>{try{let t=await T.detect(i),r=t?.rawValue??"",a=t?.format??"";if(!r)throw Error("No barcode detected");if(te(n,r),z(r,s,a),e?.addToHistory)try{await o?.add(r),v&&(v.open=!0,setTimeout(()=>{try{let t=o?.shadowRoot?.querySelector(`li[data-value="${r}"]`);t?.scrollIntoView({behavior:"smooth",block:"center"}),t?.classList?.add("highlight"),setTimeout(()=>t?.classList?.remove("highlight"),2e3)}catch(t){}},50))}catch(t){}ta()}catch(t){tt.log.error(t),tp("<strong>No barcode detected</strong><br><small>Please try again with a different image.</small>",{variant:"danger",trustDangerousInnerHTML:!0}),ta({success:!1})}},i.src=a,i.alt="Image preview",c.replaceChildren();let l=document.createElement("div");l.className="dropzone-preview";let d=document.createElement("div");d.className="dropzone-preview__image-wrapper";let h=document.createElement("div");h.className="dropzone-preview__file-name",h.textContent=t.name,d.appendChild(i),l.appendChild(d),l.appendChild(h),c.prepend(l)},r.readAsDataURL(t)}async function F(t){u?.removeAttribute("hidden"),ts(t.detail.video,u),D();let i=t.target.getTrackSettings(),o=t.target.getTrackCapabilities(),r=document.getElementById("zoomLevel");if(o?.torch&&(m?.addEventListener("click",q),m?.removeAttribute("hidden"),e.hasAttribute("torch")&&tm({el:m,isTorchOn:!0})),i?.zoom&&o?.zoom){let t=document.getElementById("zoomControls"),a=o?.zoom?.min||0,s=o?.zoom?.max||10,n=i?.zoom||1;t?.addEventListener("click",t=>{let i=t.target.closest('[data-action="zoom-in"]'),o=t.target.closest('[data-action="zoom-out"]');i&&n<s&&(n+=.5),o&&n>a&&(n-=.5),r.textContent=n.toFixed(1),e.zoom=n}),t?.removeAttribute("hidden"),r.textContent=n.toFixed(1)}let a=await tv.getVideoInputDevices();a.forEach((t,e)=>{let i=document.createElement("option");i.value=t.deviceId,i.textContent=t.label||`Camera ${e+1}`,A.appendChild(i)}),a.length>1&&(A?.addEventListener("change",$),A?.removeAttribute("hidden"))}async function B(t){t.preventDefault();let e={},i=new FormData(E),o=i.getAll("general-settings"),r=i.getAll("formats-settings");o.forEach(t=>e[t]=!0),e.formats=r,(0,X.setSettings)(e),"formats-settings"===t.target.name&&(T=await tl.create(r))}function q(t){e.torch=!e.torch,tm({el:t.currentTarget,isTorchOn:e.hasAttribute("torch")})}function $(t){if("function"!=typeof e.restartVideoStream)return;let i=t.target.value||void 0;e.restartVideoStream(i)}c.accept=J.join(","),i.supportedFormats=L,d.addEventListener("click",function(){d?.setAttribute("hidden",""),u?.removeAttribute("hidden"),N?.removeAttribute("hidden"),D()}),t.addEventListener("a-tab-show",Q(function(t){let e=t.detail.tabId,i=document.querySelector("video-capture");if("cameraTab"===e){if(C=!0,!i)return;if(!i.loading&&d.hasAttribute("hidden")&&(u?.removeAttribute("hidden"),N?.removeAttribute("hidden"),D()),"function"==typeof i.startVideoStream){let t=A?.value||void 0;i.startVideoStream(t)}}else"fileTab"===e&&(C=!1,null!=i&&"function"==typeof i.stopVideoStream&&i.stopVideoStream(),u?.setAttribute("hidden",""),N?.setAttribute("hidden",""))},250)),c.addEventListener("files-dropzone-drop",function(t){M(t.detail.acceptedFiles[0])}),h.addEventListener("resize-observer:resize",function(){ts(e.shadowRoot.querySelector("video"),u)}),b.addEventListener("click",function(){g.open=!0}),y.addEventListener("click",function(){w.open=!0}),E.addEventListener("change",Q(B,500)),f.addEventListener("click",function(){v.open=!0}),document.addEventListener("visibilitychange",function(){if("cameraTab"===t.querySelector("[selected]").getAttribute("id"))if("hidden"===document.visibilityState)C=!1,null!=e&&"function"==typeof e.stopVideoStream&&e.stopVideoStream();else{C=!0;let t=document.querySelector("video-capture");if(!t)return;if(!t.loading&&d.hasAttribute("hidden")&&D(),"function"==typeof t.startVideoStream){let e=A?.value||void 0;t.startVideoStream(e)}}}),document.addEventListener("keydown",function(e){"Escape"===e.key&&function(){let e=t.querySelector("#cameraTab").hasAttribute("selected"),i=!d.hidden,o=w.hasAttribute("open"),r=v.hasAttribute("open");i&&e&&!(o||r)&&d.click()}()}),document.addEventListener("bs-history-success",function(t){let{type:e,message:i}=t.detail;"add"===e&&tp(i,{variant:"success"})}),document.addEventListener("bs-history-error",function(t){let{type:e,message:i}=t.detail;("remove"===e||"empty"===e)&&v?.hide(),tp(i,{variant:"danger"})})}();
//# sourceMappingURL=barcode-scanner-CS465.77f4b2c0.js.map
